...
$meritos = $objMeritoDocenteConsulta->listaEstructuraMeritosSegunPersonal($personal->IdTipoPersonal);
                        ...
                        <tr>
                          ...
                          <?php foreach ($evaluacion as $eval): ?>
                            <?php if ($eval->IdEstructuraMerito == $merito->IdEstructuraMerito): ?>
                              <td><input type="text" maxlength="2" size="2" style="width: 50px" class="form-control puntaje" name="puntajeMerito[]" value="<?php echo $eval->PuntajeMerito ?>" readonly></td>
                              <?php $encontrado = true;
                              break;
                             endif; ?>
                          <?php endforeach;
                          if ($encontrado == false) {
                            ?>
                            <td><input type="text" maxlength="2" size="2" style="width: 50px" class="form-control puntaje" name="puntajeMerito[]" value="0" readonly></td>
                            <?php
                          }
                          ?>
