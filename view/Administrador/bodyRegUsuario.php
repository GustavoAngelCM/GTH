                                      ...
                                      <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="input-group selector">
                                            ...
                                            <select class="selectpicker form-control" name="tipoUsuario" id="tipoUsuario" title="Tipo de Usuario" required>
                                              <?php foreach ($listaTipoUsuario as $listaTU): ?>
                                                <?php if ($listaTU->IdTipoUsuario>1): ?>
                                          ...
                                          <div class="input-group selector-mobile">
                                            <span class="input-group-addon" style="background: red; color:white" id="sizing-addon2"><i class="fa fa-linode"></i></span>
                                            <select class="form-control" name="tipoUsuario" id="tipoUsuario-mobi" required>
                                              <option value="null" selected hidden>Tipo de Usuario</option>
                                              <?php foreach ($listaTipoUsuario as $listaTU): ?>
                                                <?php if ($listaTU->IdTipoUsuario>1): ?>
                                                  <option value="<?php echo $listaTU->IdTipoUsuario; ?>"><?php echo $listaTU->NombreTipoUsuario; ?></option>
                                                <?php endif; ?>
...
<div class="modal fade" id="modalUsuarioCreado" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content" style="border-radius: 20px;">
      <div class="modal-body">
        <div class="panel panel-success">
          <div class="panel-heading">
            <div class="text-center panel-tittle">
              <h2>Usuario Registrado</h2>
            </div>
          </div>
          <div class="panel-body">
            <p><strong>Usuario: </strong><input type="text" class="form-control" id="usuarioResp" name="usuario" value="0" disabled></p>
            <br>
            <p><strong>Contraseña: </strong><input type="text" class="form-control" id="contraResp" name="contrasena" value="0" disabled></p>
            <div class="pull-right">
              <a href="Usuario-Lista.html" class="btn btn-success">Listo <i class="fa fa-check"></i></a>
            </div>
          </div>
        </div>
      </div>
