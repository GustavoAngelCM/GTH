                      ...
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                          ...
                          <div class="pull-right">
                            <a class="btn btn-danger count-info" data-toggle="modal" data-target="#listaEliminados" ><i class="fa fa-trash" title="Personal(es) Dado(s) de Baja" data-toggle="tooltip"></i>
                              <?php if ($spanCount>0): ?>
                                <span class="label label-warning"><?php echo $spanCount ?></span>
                              <?php endif; ?>
                            </a>
                            <a href="Personal-Crear.html" class="btn btn-success"><i class="fa fa-plus" title="Añadir un nuevo Personal" data-toggle="tooltip"></i></a>
                                    ...
                                    <td class="text-left" >      <!--<a href="index.php?modo=evaluarMeritos" class="btn btn-gear"></a> -->
                                      <div class="btn-group pull-xs-right">
                                        ...
                                        <ul class="dropdown-menu inner pull-right animated fadeInRight m-t-xs" role="listbox" >
                                          ...
                                          <li>
                                            <form class="evaluarPersonal" action="Personal-Evaluacion-Meritos.html" method="post">
                                              <input type="hidden" name="datos" value="1">
                                          ...
                                          <br>
                                          <li>
                                            <form action="Personal-Curriculum.html" method="post">
                                              <input type="hidden" name="ciPersonal" value="<?php echo $personal->IdPersona->CI ?>">
                                          ...
                                          <br>
                                          <li>
                                            <form class="darDeBajaPersonal" action="Personal-Down.html" method="post">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="pull-left">
          <a class="btn btn-danger exportarFormularioPDFVER">Exportar PDF <i class="fa fa-file-pdf-o"></i></a>
        </div>
        <div class="pull-right">
          <a href="#" data-dismiss="modal" class="btn btn-danger">Cerrar <i class="fa fa-times"></i></a>
        </div>
      </div>
    </div>
  </div>
                  ...
                  <?php $i = 1; foreach ($listaPersonal as $personal): ?>
                    <?php if ($personal->Estado == 0): ?>
                      <tr>
                        ...
                        <td class="text-left"><?php echo $personal->IdTipoPersonal ?></td>
                        <td class="text-left">      <!--<a href="index.php?modo=evaluarMeritos" class="btn btn-gear"></a> -->
                          <form class="darDeBajaPersonal" action="Personal-Up.html" method="post">
                            <input type="hidden" name="ciPersonalDBAja" class="ciDBAja"  value="<?php echo $personal->IdPersona->CI ?>">
