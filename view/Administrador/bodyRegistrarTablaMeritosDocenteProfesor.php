                    ...
                    <div class="panel with-nav-tabs panel-info">
                        <div class="panel-heading" style="background:rgb(26, 74, 101)">
                            <ul class="nav nav-tabs" >
                                <li class="active" id="TablaMeritosDocenteLI"><a style="color:white" href="#HojaVida" data-toggle="tab">Tabla de Calificación de Méritos</a></li>
                            </ul>
                        </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="form-group" data-toggle="buttons">
                                         ...
                                         <div class="exportarArchivo">
                                            <input type="file" name="archivo" accept="application/xml" class="exportarArchivoFile" required />
                                         </div>
                                         <h3 class="text-left"> Examinar Archivo (*xml)</h3>
                                         <div class="nameFileImg"></div>

                                         <input type="hidden" name="datos" value="1">
                                         <div id="mesajePersona"></div>
                                         <div class="pull-right">
                                           <button type="submit" name="guardarTablaMerito" id="guardartablaMerito" class="btn btn-success">Guardar <i class="fa fa-check"></i></button>
                                         </div>
                                         <br><br>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="pull-right">
          <a href="Meritos-Lista.html" class="btn btn-success btn-lg">LISTO <i class="fa fa-check"></i></a>
        </div>
      </div>
    </div>
  </div>
