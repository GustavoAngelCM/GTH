                      ...
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                          ...
                          <div class="pull-right">
                            <a class="btn btn-success" data-toggle="modal" data-target="#modalArchivo"><i class="fa fa-plus" title="Añadir un nuevo Documento" data-toggle="tooltip"></i></a>
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control " name="nombreArchivo" id="nombreDeArchivos" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="selectpicker form-control show-tick" id="tipoDeArchivos" name="tipoArchivo" title="Tipo de Archivo" required>
