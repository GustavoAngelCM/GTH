                    ...
                    <tbody class="text-center">
                      ...
                      <tr>
                        <form id="reportePersonalCantidad">
                          <td>2</td>
                          <td>Cantidad Personal Docente por Facultad</td>
                          <td>
                      ...
                      <tr>
                        <form id="reporteCantidad">
                          <td>3</td>
                          <td>Cantidad Tipo de Personal </td>
                          <td>
                            <select class="selectpicker form-control show-tick " data-container="body" id="tipoTituloProfesionalReporteTipo" name="tipoPersonal" data-width="100px"  title="Tipo de Personal" >
                              <option value="0" selected>Todos</option>
                              <?php foreach ($listaTipoTituloProfesional as $listaTipoTP): ?>
                                <option value="<?php echo $listaTipoTP->IdTipoTituloProfesional; ?>"><?php echo $listaTipoTP->NombreTipoTitulo; ?></option>
                              <?php endforeach; ?>
                          ...
                          <td><button type="submit" id="reporteGrapTipoPersonal" name="button" class="btn btn-primary">Generar</button></td>
                        </form>
                      </tr>

                      <tr>
                        <form id="usuarioListaFrm">
                          <td>4</td>
                          <td>Lista de Usuarios</td>
                          <td>
                              <select class="selectpicker form-control show-tick " data-container="body" id="usuarioLista" name="tipoPersonal" data-width="100px"  title="Tipo de Personal" >
                                <option value="0" selected>Todos</option>
                              <?php foreach ($listaTipoPersonal as $listaTP): ?>
                                <option value="<?php echo $listaTP->IdTipoPersonal; ?>"><?php echo $listaTP->NombreTipoPersonal; ?></option>
                              <?php endforeach; ?>
                          ...
                          <td></td>
                          <td></td>
                          <td><button type="submit" data-toggle="modal" data-target="#respuestaReporte" class="btn btn-primary">Generar</button></td>
                        </form>
                      </tr>
                    </tbody>
                  </table>
