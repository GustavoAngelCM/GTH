                ...
                <ul class="nav " id="side-menu">
                    ...
                    <li class="menu-efec">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="menu-efec"><a href="Personal-Crear.html"><i class="fa fa-plus"></i>Nuevo Personal</a></li>
                            <li  class="menu-efec"><a href="Personal-Lista.html"><i class="fa fa-list"></i>Lista</a></li>
                        </ul>
                    </li>
                    <li class="menu-efec">
                        <a href="#"><i class="fa fa-user"></i> <span class="nav-label">Usuario</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li class="menu-efec"><a href="Usuario-Crear.html"><i class="fa fa-plus"></i>Nuevo Usuario</a></li>
                            <li  class="menu-efec"><a href="Usuario-Lista.html"><i class="fa fa-list"></i>Lista</a></li>
                        </ul>
                    </li>
                    <li class="menu-efec">
                    ...
                    <li class="menu-efec">
                        <a href="Personal-Birthday.html"><i class="fa fa-birthday-cake"></i> <span class="nav-label">Cumpleañeros</span></a>
                    </li>
                    <li class="menu-efec">
                        <a href="Documentos.html"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Documentos</span></a>
                    </li>
                    <li class="menu-efec">
                        <a data-toggle="modal" data-target=".working"><i class="fa fa-car"></i> <span class="nav-label">Vacaciones</span></a>
                    </li>
                    <li class="menu-efec">
                        <a data-toggle="modal" data-target=".working"><i class="fa fa-inbox"></i> <span class="nav-label">Buzón de Sugerencias</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" id="manual-usuario"><i class="fa fa-book"></i> <span class="nav-label">Manual</span></a>
                    </li>
                </ul>
            </div>
        </nav>
