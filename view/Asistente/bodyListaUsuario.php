                      ...
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                          ...
                          <div class="pull-right">
                            <a href="Usuario-Lista.html"  class="btn btn-success"><i class="fa fa-plus" title="Añadir un nuevo Usuario" data-toggle="tooltip"></i></a>
                          ...
                          <table class="table table-hover" id="dev-table" >
                            <tbody class="text-center">
                              ...
                              <?php foreach ($listaUsuario as $usuario): ?>
                                <?php if (($usuario['NombreTipoUsuario'] != "Administrador") && ($usuario['NombreTipoUsuario'] != "Asistente") ): ?>
                                  <tr>
                                    <td><?php echo $i ?></td>
