                                ...
                                <form id="frmPersonalEditar">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-10 col-md-8">
                                      ...
                                      <div class="form-group componentePersonal" id="cargoPersonalSelect">
                                        <label>Cargo</label>
                                        <div class="input-group selector">
                                      ...
                                      <div class="form-group componentePersonal" id="carreraPersonalSelect">
                                ...
                                <div class="panel with-nav-tabs panel-primary">
                                  <div class="panel-heading" >
                                    <ul class="nav nav-tabs" >
                                        ...
                                        <li id="ExperienciaLaboralLI"><a style="color:white" href="#ExperienciaLaboral" data-toggle="tab">Experiencia Laboral</a></li>
                                  </div>
                                </div>
                                <div class="panel-body" style="display: block; background:white">
                                  <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="Titulos">
                                      <h2 class="text-center" style="color:orange">Doctorados, maestrías y especialidades presentar en oficinas de GTH</h2>
                                      <form id="TiulosFrm">
                                        <div class="row">
                                          <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="form-group">
                                              ...
                                              <div class="input-group selector">
                                                ...
                                                <select class="selectpicker form-control inputTitulosBk" name="tipoTituloProfesional" id="tipoTituloProfesional">
                                                  <?php foreach ($listaTipoTituloProfesional as $listaTipoTP): ?>
                                                    <?php if ($listaTipoTP->IdTipoTituloProfesional<3 || $listaTipoTP->IdTipoTituloProfesional>5): ?>
