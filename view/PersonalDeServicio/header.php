...
<head>
    ...
    <title>Personal de Servicio</title>
        ...
        <nav class="navbar-default navbar-static-side nav-side-menu" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav " id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                          ...
                          <ul class="dropdown-menu animated fadeInRight m-t-xs">
                              <li><a data-toggle="modal" data-target="#modalView">Perfil</a></li>
                    ...
                    <li class="menu-efec">
                        <a class="efec" href="Personal-Editar.html"><i class="fa fa-male"></i><span class="nav-label">Mis Datos</span></a></li>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" href="Personal-Curriculum.html"><i class="fa fa-archive"></i> <span class="nav-label">Mis Archivos</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" href="Directorio.html"><i class="fa fa-address-book"></i><span class="nav-label">Directorio</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" href="Personal-Birthday.html"><i class="fa fa-birthday-cake"></i> <span class="nav-label">Cumpleañeros</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" href="Documentos.html"><i class="fa fa-book"></i> <span class="nav-label">Documentos</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" href="Personal-Evaluacion-Meritos.html" ><i class="fa fa-check-square"></i> <span class="nav-label">Evaluación de Desempeño</span></a>
                    </li>
                    <li class="menu-efec">
                    ...
                    <li class="menu-efec">
                        <a class="efec" data-toggle="modal" data-target=".working"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Descripción de Funciones</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" data-toggle="modal" data-target=".working"><i class="fa fa-automobile"></i> <span class="nav-label">Control de Vacaciones</span></a>
                    </li>
                    <li class="menu-efec">
                        <a class="efec" id="manual-usuario-all"><i class="fa fa-book"></i> <span class="nav-label">Manual Usuario</span></a>
                    </li>
                </ul>
            </div>
        </nav>
