...
//show the dialog
alertify.YoutubeDialog('rmKzOBJTfL8').set({frameless:true});
  });
}
...
function navEfect()
{
  ...
  $(window).scroll(function() {
    if ($("#mainNav").offset().top > ventana_alto)
    {
...
//show the dialog
alertify.YoutubeDialog('2dOzolBWARc').set({frameless:true});
  });
}
