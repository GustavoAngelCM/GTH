...
class PersonalControlador
{
  ...
  public function contactosPersonal($lista)
  {

      ?>
      <div class="table-responsive contacto-mensaje">
            ...
            foreach ($lista as $key => $value)
            {
              ...
              <tr style="cursor:pointer"> 
                <td>
                  <?php if ( $value->Ruta): ?>
                    <?php
                      list($nada,$ruta) = explode("/wamp64/www/PersonalUAB/view/", $value->Ruta);
                    ?>
                    <img src="‪<?php echo "../../../".$ruta ?>" class="img-responsive" style="border-radius:50%;" width="50" height="50">
                  <?php else: ?>
                    <img src='http://localhost:88/PersonalUAB/view/libs/multimedia/img/design/user.png' class="img-responsive" style="border-radius:50%;" width="50" height="50">
                  <?php endif; ?>
                </td>
                <td><h3><?php echo "{$value->IdPersona->PrimerNombre} {$value->IdPersona->ApellidoPaterno}" ?></h3></td>
              </tr>
              <?php
            }
            ?>
  ...
  public function editar()
  {
    ...
    $personal->Email = ($_POST['email']=="") ? null : $_POST['email'];
    $personal->IdCiudadNacimiento = ($_POST['ciudad']=="") ? null : $_POST['ciudad'];
    $personal->IdReligion = ($_POST['religion']=="") ? null : $_POST['religion'];
    $personal->FechaBautizmo = ($_POST['fechaBau']=="") ? null : $_POST['fechaBau'];
    $personal->IdSeguro = ($_POST['seguro']=="") ? null : $_POST['seguro'];
    $personal->NumeroSeguro = ($_POST['numSeguro']=="") ? null : $_POST['numSeguro'];
    $personal->IdAfp = ($_POST['afp']=="") ? null : $_POST['afp'];
    $personal->NumeroAfp = ($_POST['numAfp']=="") ? null : $_POST['numAfp'];
    $personal->NumeroLibretaMilitar = ($_POST['numLibMilitar']=="") ? null : $_POST['numLibMilitar'];
    $personal->NumeroPasaporte = ($_POST['numPasaporte']=="") ? null : $_POST['numPasaporte'];
    $personal->TipoSangre = $_POST['tipoSangre'];
    $personal->Hobby = $_POST['hobby'];
    $personal->LecturaPreferencial = $_POST['lecturaP'];
    $personal->NumeroRegistroProfesional = ($_POST['numeroRegProfesional']=="") ? null : $_POST['numeroRegProfesional'];
  ...
  public function crearPreventUsuario($idPersona)
  {
    ...
    $personal->IdCarrera = (isset($_POST['carrera'])) ? $_POST['carrera'] : null ;
    $personal->IdCargo = (isset($_POST['cargoPersonal'])) ? $_POST['cargoPersonal'] : null ;
    $personal->Direccion = "";
