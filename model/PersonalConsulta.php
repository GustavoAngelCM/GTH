...
class PersonalConsulta
{
  ...
  public function cantidadTituloPersonalDocente($post)
  {
    $query = "SELECT
              count(distinct  p.idPersonal) as cantidad
              FROM personal p, cargoPersona cp, carrera c, facultad f, tituloprofesional tp
              where p.idCargoPersona = cp.idCargoPersona
              and p.idCarrera = c.idCarrera
              and c.idFacultad = f.idFacultad
              and p.idPersonal = tp.idPersonal
              and p.estado = 1
              and p.idCargoPersona = 1
              and f.idFacultad = 1
              and tp.idTipoTituloProfesional = :tipoTitulo";
    $consulta = $this->Conexion->prepare($query);
    $consulta->bindValue(':tipoTitulo', $post['tipoTituloProfesional']);
    $consulta->execute();
    $cantidadIngenieria = $consulta->fetch();
  ...
  public function cantidadTituloSexoPersonalDocente($post)
  {
    $query = "SELECT
              count(distinct  p.idPersonal) as cantidad
              FROM personal p, cargoPersona cp, carrera c, facultad f, tituloprofesional tp, persona pe
              where p.idCargoPersona = cp.idCargoPersona
              and p.idCarrera = c.idCarrera
              and c.idFacultad = f.idFacultad
              and p.idPersona = pe.idPersona
  ...
  public function cantidadTipoPersonal()
  {
    $query = "SELECT
              count(distinct  p.idPersonal) as cantidad
              FROM personal p, persona pe
              where p.idPersona = pe.idPersona
              and p.idTipoPersonal=1
              and pe.sexo = 'M'
              and p.estado = 1";
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalAcademicoM = $consulta->fetch();
    ...
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalAcademicoF = $consulta->fetch();
    ...
    $query = "SELECT
              ...
              FROM personal p, persona pe
              where p.idPersona = pe.idPersona
              and p.idTipoPersonal=2
              and pe.sexo = 'M'
              and p.estado = 1";
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalPlantaM = $consulta->fetch();
    ...
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalPlantaF = $consulta->fetch();
    ...
    $query = "SELECT
              ...
              FROM personal p, persona pe
              where p.idPersona = pe.idPersona
              and p.idTipoPersonal=3
              and pe.sexo = 'M'
              and p.estado = 1";
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadProfesoresM = $consulta->fetch();
    ...
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadProfesoresF = $consulta->fetch();
    ...
    $query = "SELECT
              ...
              FROM personal p, persona pe
              where p.idPersona = pe.idPersona
              and p.idTipoPersonal=4
              and pe.sexo = 'M'
              and p.estado = 1";
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalServiciosM = $consulta->fetch();
    ...
    $consulta = $this->Conexion->prepare($query);
    $consulta->execute();
    $cantidadPersonalServiciosF = $consulta->fetch();

    $registro = array(0 => round($cantidadPersonalAcademicoM['cantidad'],1),
            				  1 => round($cantidadPersonalAcademicoF['cantidad'],1),
            				  2 => round($cantidadPersonalPlantaM['cantidad'],1),
            				  3 => round($cantidadPersonalPlantaF['cantidad'],1),
            				  4 => round($cantidadProfesoresM['cantidad'],1),
                      5 => round($cantidadProfesoresF['cantidad'],1),
                      6 => round($cantidadPersonalServiciosM['cantidad'],1),
                      7 => round($cantidadPersonalServiciosF['cantidad'],1)
            				  );

    return $registro;
  }

  public function cantidadTipoPersonalTitulo($post)
  {
    $query = "SELECT
              count(distinct  p.idPersonal) as cantidad
              FROM personal p, persona pe, tituloprofesional tp
              where p.idPersona = pe.idPersona
              and p.idPersonal = tp.idPersonal
              and p.idTipoPersonal=1
              and pe.sexo = 'M'
